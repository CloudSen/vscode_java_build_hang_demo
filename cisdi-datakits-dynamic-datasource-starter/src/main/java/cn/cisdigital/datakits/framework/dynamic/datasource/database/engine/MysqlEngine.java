...
import static cn.cisdigital.datakits.framework.dynamic.datasource.common.DatabaseConstants.MYSQL_INNODB_ENGINE_NAME;
 ...
 * @author xxx
 */
public class MysqlEngine implements DatabaseEngineStrategy<MysqlEngineDto> {
    ...
    public boolean doCheckActualDatabaseType(List<MysqlEngineDto> engineModelList) {
        return CollUtil.findOne(engineModelList, engine -> engine.getEngine().equalsIgnoreCase(MYSQL_INNODB_ENGINE_NAME)) != null;
    }
}
