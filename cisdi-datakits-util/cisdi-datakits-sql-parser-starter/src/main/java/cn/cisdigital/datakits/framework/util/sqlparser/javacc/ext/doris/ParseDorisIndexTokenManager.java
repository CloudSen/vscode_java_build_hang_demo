/* Generated By:JavaCC: Do not edit this line. ParseDorisIndexTokenManager.java */
...
public class ParseDorisIndexTokenManager implements ParseDorisIndexConstants
{
...
private final int jjMoveStringLiteralDfa9_0(long old0, long active0)
{
   ...
   switch(curChar)
   {
      ...
      case 115:
         if ((active0 & 0x1000L) != 0L)
            return jjStartNfaWithStates_0(9, 12, 15);
         break;
      default :
         break;
   }
...
public ParseDorisIndexTokenManager(SimpleCharStream stream){
   if (SimpleCharStream.staticFlag)
      throw new Error("ERROR: Cannot use a static CharStream class with a non-static lexical analyzer.");
   input_stream = stream;
}
public ParseDorisIndexTokenManager(SimpleCharStream stream, int lexState){
   this(stream);
   SwitchTo(lexState);
}
