 ...
 */
public class DorisBasicSqlType extends AbstractSqlType implements IDatakitsFieldType {
    ...
    public DorisBasicSqlType(final RelDataTypeSystem typeSystem, final SqlTypeName typeName) {
        this(typeSystem, typeName, null, null);
        checkPrecScale(typeName, false, false);
    }

    public DorisBasicSqlType(final RelDataTypeSystem typeSystem, final SqlTypeName typeName, final DorisColumnEnum dorisColumnEnum,
                             final String comment) {
        this(typeSystem, typeName, false, PRECISION_NOT_SPECIFIED, SCALE_NOT_SPECIFIED, null,
                null, dorisColumnEnum, comment);
        checkPrecScale(typeName, false, false);
    }

    public DorisBasicSqlType(final RelDataTypeSystem typeSystem, final SqlTypeName typeName, final DorisColumnEnum dorisColumnEnum,
                             final String comment, final boolean nullable) {
        this(typeSystem, typeName, nullable, PRECISION_NOT_SPECIFIED, SCALE_NOT_SPECIFIED, null,
                null, dorisColumnEnum, comment);
        checkPrecScale(typeName, false, false);
    }
    ...
    DorisBasicSqlType createWithCharsetAndCollation(Charset charset,
                                                    SqlCollation collation) {
        Preconditions.checkArgument(SqlTypeUtil.inCharFamily(this));
        return new DorisBasicSqlType(this.typeSystem, this.typeName, this.isNullable,
                this.precision, this.scale, collation, SerializableCharset.forCharset(charset)
                , this.columnType, this.comment);
    }

    DorisBasicSqlType createWithNullability(boolean nullable) {
        if (nullable == this.isNullable) {
            return this;
        }
        return new DorisBasicSqlType(this.typeSystem, this.typeName, nullable,
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof DorisBasicSqlType)) {
            return false;
        }
        ...
        final DorisBasicSqlType other = (DorisBasicSqlType) obj;
