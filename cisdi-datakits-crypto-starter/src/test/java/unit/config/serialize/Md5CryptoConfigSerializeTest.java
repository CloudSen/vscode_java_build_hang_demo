...
public class Md5CryptoConfigSerializeTest extends SerializeBaseTest {

    @ParameterizedTest
    @ValueSource(booleans = { true, false })
    void success_md5_random_salt_deserialize(boolean isRandomSalt) {
        assertDoesNotThrow(() -> {
            CryptoConfig cryptoConfig = new Md5CryptoConfig()
            ...
            if (isRandomSalt) {
                assertThat(json).isEqualTo("{\"cryptoType\":\"MD5\",\"salt\":\"123\",\"saltSize\":6,\"randomSalt\":true}");
            } else {
                assertThat(json).isEqualTo("{\"cryptoType\":\"MD5\",\"salt\":\"123\",\"saltSize\":6,\"randomSalt\":false}");
            }
    ...
    @Test
    void success_serialize_md5_fix_salt() {
        assertDoesNotThrow(() -> {
            CryptoConfig cryptoConfig = new Md5CryptoConfig()
                    .setSalt("123");
            System.out.println("原始配置：");
            ...
            System.out.println("原始配置序列化json：");
            System.out.println(json);
            assertThat(json).isEqualTo("{\"cryptoType\":\"MD5\",\"salt\":\"123\",\"saltSize\":8,\"randomSalt\":false}");
